    ...
    return (
        <>
            <Swiper style={{ height: 'auto', borderRadius: '2rem', "--swiper-pagination-color": "#C508A7", "--swiper-pagination-bullet-size": "0.8rem",
                ...
                <SwiperSlide style={{backgroundColor:'black', borderRadius:'2rem', height:'auto'}} data-cursor-text='Glimpses' data-cursor-size='180px' data-cursor-color='rgba(0,0,0,0,2)'> <div > <Image src="/first.png" alt="image1" width={1600} height={900} className={styles.carImg} /></div></SwiperSlide>
                <SwiperSlide style={{backgroundColor:'black', borderRadius:'2rem', height:'auto'}} data-cursor-text='Our sponsor' data-cursor-size='180px' data-cursor-color='rgba(0,0,0,0,2)'> <div > <Image src="/fifth.jpg" alt="image5" width={1600} height={900} onClick={handlemaddyClick} className={styles.carImg} /></div></SwiperSlide>
